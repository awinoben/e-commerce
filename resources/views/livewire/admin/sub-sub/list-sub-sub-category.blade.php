                    ...
                    <div wire:poll.60000ms>
                        ...
                        <div wire:init="loadData">
                            <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        @foreach($subcategories as $subcategory)
                                            <tr>
                                                ...
                                                <td>{{ $subcategory->sub_category->name }}</td>
                                                <td>{{ date('F d, Y h:i a', strtotime($subcategory->updated_at)) }}</td>
                                                <td>
                                                    <a href="{{ route('admin.edit.sub.sub.category',['id'=> $subcategory->id]) }}"
                                ...
                                @else
                                    <p class="text-center">No sub-subcategories were found...</p>
                                @endif
