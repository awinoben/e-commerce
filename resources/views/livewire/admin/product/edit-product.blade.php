    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title"><a href="{{ route('admin.list.product') }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <form wire:submit.prevent="submit">
                                    ...
                                    <div class="form-group" {{ $is_accessories ? '' : 'hidden' }}>
                                        <label for="access_category_id">Select Category</label>
                                    ...
                                    <div class="form-group">
                                        <label for="model">Model <span class="text-primary">optional</span></label>
                                        <input type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               id="part_number" placeholder="Enter part_number"
                                    ...
                                    <div class="form-group">
                                        <label for="reordering_level">Re-Ordering Level</label>
                                        <input type="number"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <label for="weight_value">Value</label>
