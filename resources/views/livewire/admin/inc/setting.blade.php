                    ...
                    <div class="list-group list-group-flush">
                        <a href="chat.html" class="list-group-item d-flex px-0 align-items-center">
                            ...
                            <span class="avatar avatar-state-danger">
                                <img src="http://baston.laborasyon.com/assets/media/image/user/women_avatar3.jpg"
                        ...
                        <a href="chat.html" class="list-group-item d-flex px-0 align-items-center">
                            ...
                            <span class="avatar avatar-state-warning">
                                <img src="http://baston.laborasyon.com/assets/media/image/user/man_avatar4.jpg"
                                     class="rounded-circle"
                                     alt="image">
                            </span>
                            </div>
                        ...
                        <a href="chat.html" class="list-group-item px-0 d-flex align-items-center">
                            <div class="pr-3">
                                <div class="avatar avatar-state-success">
                                    <img src="http://baston.laborasyon.com/assets/media/image/user/women_avatar1.jpg"
                                         class="rounded-circle"
                                         alt="image">
                                </div>
                            </div>
                        ...
                        <a href="chat.html" class="list-group-item d-flex px-0 align-items-center">
                            <div class="pr-3">
                            <span class="avatar avatar-state-warning">
                                <img src="http://baston.laborasyon.com/assets/media/image/user/women_avatar2.jpg"
                                     class="rounded-circle"
                                     alt="image">
                            </span>
                            </div>
                        ...
                        <a href="chat.html" class="list-group-item d-flex px-0 align-items-center">
                            ...
                            <span class="avatar avatar-state-info">
                                <img src="http://baston.laborasyon.com/assets/media/image/user/man_avatar1.jpg"
                                     class="rounded-circle"
                                     alt="image">
                            </span>
                            </div>
                        ...
                        <a href="chat.html" class="list-group-item d-flex px-0 align-items-center">
                            ...
                            <span class="avatar avatar-state-success">
                                <img src="http://baston.laborasyon.com/assets/media/image/user/man_avatar2.jpg"
                                     class="rounded-circle"
                                     alt="image">
                            </span>
                            </div>
