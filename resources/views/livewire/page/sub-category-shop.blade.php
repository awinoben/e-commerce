                ...
                <div class="col-lg-9">
                        <div class="input-group input-group-sm mt-3">
                            <div class="input-group-prepend">
                                <select name="brand_id" id="brand_id" aria-label="Small"
                                    aria-describedby="inputGroup-sizing-sm" class="input-group-text" wire:model="brand_id">
                                        ...
                                        <div class="item-product pt-0">
                                            <div class="product-thumb">
                                                <a href="{{ route('product.page', ['id' => $product->id]) }}">
                                                    <img src="{{ isset($product->product_image->front_image) ? asset('storage/photos/' . $product->product_image->front_image) : \App\Http\Controllers\SystemController::generateAvatars($product->slug, 300) }}"
                                                        alt="" class="img-fluid">
                                                </a>
