...
class EditSubSubCategory extends Component
{
    public $name;
    public $category_id;
    ...
    {
        $this->sub_category = SubSubCategory::query()->findOrFail($id);
    ...
    public function confirmed()
    {
        ...
        $sub_category->save();
        Note::createSystemNotification(Admin::class, 'Sub-SubCategory Update', $this->name . ' updated successfully.');
        $this->emit('noteAdded');
        $this->alert(
            'success',
            'Sub-SubCategory successfully updated.'
        );
    }
    ...
    {
        return view('livewire.admin.sub-sub.edit-sub-sub-category', [
            'sub_category' => $this->sub_category,
            'categories' => Category::query()->orderBy('name')->get(),
            'sub_categories' => SubCategory::query()->orderBy('name')->whereIn('category_id', [$this->category_id])->get(),
